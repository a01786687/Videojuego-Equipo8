...
CREATE TABLE sessions(
    ...
    session_user_id SMALLINT UNSIGNED,
...
CREATE TABLE character_deck(
    ...
    cd_card_id TINYINT UNSIGNED,
    cd_user_character_id SMALLINT UNSIGNED,
